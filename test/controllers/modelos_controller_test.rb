...
class ModelosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post modelos_url, params: { modelo: { marca_id: @modelo.marca_id, name: @modelo.name } }
    end
  ...
  test "should update modelo" do
    patch modelo_url(@modelo), params: { modelo: { marca_id: @modelo.marca_id, name: @modelo.name } }
